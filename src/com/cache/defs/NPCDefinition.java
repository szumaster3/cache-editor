...
public final class NPCDefinition implements Cloneable {
    ...
    public static NPCDefinition getNPCDefinitions(int id, Cache cache) {
        NPCDefinition def = (NPCDefinition) npcDefinitions.get(Integer.valueOf(id));
        if (def == null) {
    ...
    public static NPCDefinition getNPCDefinition(Cache cache, int npcId, boolean load) {
    ...
    public int[] getNPCChatHeads() {
        return this.anIntArray892;
    }
    ...
    public void setClientScriptData(Map<Integer, Object> clientScriptData) {
        this.clientScriptData = (HashMap<Integer, Object>) clientScriptData;
    }

    public void setNpcHeight(int npcHeight) {
        this.npcHeight = npcHeight;
    }

    public void setNpcWidth(int npcWidth) {
