...
class SequenceDefinition {
    ...
    companion object {
        private val sequenceDefinitionCache = ConcurrentHashMap<Int, SequenceDefinition>()
        ...
        fun getAnimationDefinitions(
            ...
            try {
                sequenceDefinitionCache[emoteId] ?: run {
                    ...
                    sequenceDefinitionCache[emoteId] = definition
                    definition
                }
            } catch (e: Throwable) {
                null
