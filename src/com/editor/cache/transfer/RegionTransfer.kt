package com.editor.cache.transfer
...
class RegionTransfer(
    ...
    private fun createCalculateRegionButton() =
        JButton("Calculate Region").apply {
            addActionListener {
    ...
    private fun createCalculateRegionIdButton() =
        JButton("Calculate Region ID").apply {
            addActionListener {
