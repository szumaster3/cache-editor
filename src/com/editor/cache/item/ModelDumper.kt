...
internal class ModelDumper(cache: String) : JFrame() {
    ...
    public fun submitAction(cache: String) {
        ...
        try {
            ...
            val filePath = "data/export/$modelId.dat"
            writeFile(data!!, filePath)
            log("ModelDumper", "Dumped Model ID: $modelId to: $filePath")
        } catch (e: IOException) {
            log("ModelDumper", "Cannot Dump Model")
        } catch (e: NumberFormatException) {
            log("ModelDumper", "Invalid Model ID")
        }
    }
