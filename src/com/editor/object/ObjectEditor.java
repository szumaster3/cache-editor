...
public class ObjectEditor extends JFrame {
    ...
    /**
     * Instantiates a new Object editor.
     *
     * @param os   the os
     * @param defs the defs
     */
    ...
    private void save() {
        try {
            ...
            ObjectSelection var10001 = this.os;
            this.defs.write(ObjectSelection.STORE);
            this.os.updateObjectDef(this.defs);
