...
import com.editor.model.mouse.*;
import com.editor.model.render.Renderer;
...
public class Main extends JFrame implements Runnable {
    ...
    private com.editor.model.render.Canvas model;
    private JFileChooser fileChooser1;
    JFileChooser fileChooser2;
    private static com.editor.model.render.Renderer renderer;
    ...
    public static void listSelectionValueChanged(Main main, ListSelectionEvent var1) {
        if (!var1.getValueIsAdjusting()) {
            ...
            byte[] modelBytes;
            com.editor.model.render.Canvas model;
            if ((modelBytes = getBytesFromFile(main.directoryPath + System.getProperty("file.separator") + fileName))[modelBytes.length - 1] == -1 && modelBytes[modelBytes.length - 2] == -1) {
                if ((model = com.editor.model.render.Canvas.loadModel(modelBytes)).isNewHeader) {
                    model.downScaleModel(4);
                }
            } else {
                com.editor.model.render.Canvas.initModel(modelBytes);
                model = com.editor.model.render.Canvas.createEmptyModel();
            }
