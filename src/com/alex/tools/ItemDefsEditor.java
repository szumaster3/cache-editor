...
public class ItemDefsEditor extends JDialog {
    ...
    public ItemDefsEditor(Application application, ItemDefinitions defs) {
        ...
        this.nameField.setText(defs.name);
        ...
        String var14 = "";
        String[] label_1 = defs.groundOptions;
        ...
        this.femaleModelId2Field.setText("" + defs.getFemaleEquipModelId2());
        ...
        this.maleModelId1Field.setText("" + defs.getMaleEquipModelId1());
        ...
        this.maleModelId2Field.setText("" + defs.getMaleEquipModelId2());
        ...
        this.femaleModelId1Field.setText("" + defs.getFemaleEquipModelId1());
        ...
        this.membersOnlyCheck.setSelected(defs.isMembersOnly());
    ...
    public void save() {
        ...
        this.defs.name = this.nameField.getText();
        ...
        for (int var9 = 0; var9 < this.defs.groundOptions.length; ++var9) {
            this.defs.groundOptions[var9] = groundOptions[var9].equals("null") ? null : groundOptions[var9];
        }

        String[] var91 = this.inventoryOptionsField.getText().split(";");

        for (int t = 0; t < this.defs.inventoryOptions.length; ++t) {
            this.defs.inventoryOptions[t] = var91[t].equals("null") ? null : var91[t];
        }

        this.defs.setMaleEquipModelId1(Integer.valueOf(this.maleModelId1Field.getText()).intValue());
        this.defs.setMaleEquipModelId2(Integer.valueOf(this.maleModelId2Field.getText()).intValue());
        this.defs.maleEquipModelId3 = Integer.valueOf(this.maleModelId3Field.getText()).intValue();
        this.defs.setFemaleEquipModelId1(Integer.valueOf(this.femaleModelId1Field.getText()).intValue());
        this.defs.setFemaleEquipModelId2(Integer.valueOf(this.femaleModelId2Field.getText()).intValue());
        ...
        this.defs.setMembersOnly(this.membersOnlyCheck.isSelected());
