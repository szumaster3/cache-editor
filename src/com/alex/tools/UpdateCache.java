...
public class UpdateCache {
    ...
    public static void main555(String[] args) throws IOException {
        ...
        for (int i$ = 0; i$ < len$; ++i$) {
            ...
            int[] arr$1 = originalCache.getIndexes()[19].getTable().getArchives()[i].validFileIds;
    ...
    public static void packCustomItems(Store cache) throws IOException {
        ...
        donatorCape.name = "Donator cape";
        donatorCape.setFemaleEquipModelId1(modelID);
        donatorCape.setMaleEquipModelId1(modelID);
        donatorCape.setInvModelId(modelID);
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (!updateJustMaps) {
            ...
            for (var17 = 0; var17 < var22; ++var17) {
                ...
                xteas = originalCache.getIndexes()[17].getTable().getArchives()[data].validFileIds;
