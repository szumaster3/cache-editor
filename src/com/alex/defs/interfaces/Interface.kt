 ...
 * The type Interface.
 */
class Interface @JvmOverloads constructor(
    /**
     * The Id.
     */
    var id: Int,
     ...
     * @return the image
     */
    fun resizeImage(image: Image, width: Int, height: Int, c: Component): Image {
